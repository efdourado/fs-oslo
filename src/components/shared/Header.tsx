      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center space-x-1 group">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-300 to-indigo-400 dark:from-blue-500 dark:to-indigo-600 rounded-lg flex items-center justify-center transition-transform duration-200 group-hover:scale-105">
                ...
                <nav className="hidden md:flex items-center gap-1">
                  ...
                  {isAdmin && (
                    <>
                      ...
                      <Button asChild variant="ghost" size="sm" className="gap-2">
                        <Link href="/questions"><PlusCircle className="h-4 w-4" />Questões</Link>
                      </Button>
                    </>
                  )}
                  {isAdmin && (
                    <Button asChild variant="ghost" size="sm" className="gap-2">
                      <Link href="/subjects"><Activity className="h-4 w-4" />Sessões</Link>
                    </Button>
                  )}
                </nav>
